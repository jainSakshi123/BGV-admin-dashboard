...
function DataTableDemo({
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-2 sm:justify-between sm:gap-0 gap-[10px] justify-start  rounded-[6px] mb-4 px-0   ">
          ...
          {userName ? (
            <>
              <Input
                ...
                className="sm:w-auto w-full h-[40px] pl-[40px]"
              />

              <Search
                className="absolute top-[18px] left-[11px] w-[18px] "
                style={{ stroke: "#898989" }}
              />
            </>
          ) : (
            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <TableHead key={header.id} className="custom-dataTable-btn">
                  ...
                  {showSkeleton ? (
                    customArray.map((value, index) => (
                      <div
                        ...
                        className="flex items-center space-x-4 py-[12px] border-b border-b-[#e5e5e5]"
                      >
      ...
      <div className="block items-center justify-end space-x-2 py-5">
